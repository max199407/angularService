...
class LiveVariableAnalyzer {
    ...
    analyze(root, cfg) {
        this.root = (navigation_1.is(root, ...navigation_1.FUNCTION_LIKE)
            ? root
    ...
    isUsedInNestedFunctions(symbol) {
        return this.symbols
            .allUsages(symbol)
            .some(usage => navigation_1.firstLocalAncestor(usage.node, ...LiveVariableAnalyzer.FUNCTION_OR_SOURCE_FILE) !== this.root);
    }
