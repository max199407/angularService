...
export declare class SymbolTableBuilder extends tslint.SyntaxWalker {
    ...
    private registerWriteUsageForAssignment(node);
    ...
    private addVariable(node);
    private registerUsageIfMissing(node, flags);
}
