...
class Walker extends tslint.ProgramAwareRuleWalker {
    ...
    visitAccessor(accessor, setterOrGetter) {
        ...
        if (containingStructure.kind === ts.SyntaxKind.ObjectLiteralExpression) {
            ...
            matchingField = Walker.matchingField(Array.from(containingStructure.members), Walker.fieldsDeclaredInConstructorParameters(containingStructure), setterOrGetter.name);
